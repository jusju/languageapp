...
public class StudentListSignUpApplication {
	...
	@Bean
	public CommandLineRunner studentDemo(StudentRepository srepository, DepartmentRepository drepository, AppUserRepository urepository, FlashcardReposirory frepository) {
		return (args) -> {
			...
			AppUser user1 = new AppUser("user", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6","jtjuslin@kapsi.fi", "USER");
			AppUser user2 = new AppUser("admin", "$2a$10$0MMwY.IQqpsVc1jC8u7IJ.2rT8b0Cd3b3sfIBGV2zfgnPGtT4r0.C", "jtjuslin@kapsi.fi", "ADMIN");
			urepository.save(user1);
			urepository.save(user2);
			
			Flashcard card1 = new Flashcard("njet", "ei");
			Flashcard card2 = new Flashcard("njet boni mai", "en ymmärrä");
			Flashcard card3 = new Flashcard("je nis najo", "en tiedä");
			frepository.save(card1);
			frepository.save(card2);
			frepository.save(card3);
